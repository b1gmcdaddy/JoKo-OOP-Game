...
public class Main extends Application {
    ...
    public void startGame() {
        ...
        L2partform4 = new Platform(0, 520, 100, 15, "file:src/application/CaveTile.png");
        ...
        enemy = new Enemy(player, 50, "file:src/application/enemy-sprite.png", .5);
        ...
        trap13 = new Traps(320, 473, 25, 13, "file:src/application/trap.png");
        ...
        double startX = 600;
        double startY = 850;
        enemy.initializeStartPosition(startX, startY);
    ...
    private void gameComplete() {
        ...
        homeLayout.setAlignment(Pos.CENTER);
        homeLayout.setStyle("-fx-background-color: linear-gradient(to top, #FF0000, #FFA500, #D2B48C, #FFFFFF);");


        Image logoImage = new Image("file:src/application/gameCompleteLogo.png");
        ImageView logoImageView = new ImageView(logoImage);

        Button replayButton = new Button("RETURN TO HELL");
        Button exitButton = new Button("EXIT");

        replayButton.setOnAction(e -> startGame());
        exitButton.setOnAction(e -> primaryStage.close());
        
        replayButton.setStyle("-fx-background-color: red; -fx-text-fill: white; -fx-font-size: 20px; -fx-padding: 10px 20px; -fx-border-color: black; -fx-border-width: 2px; -fx-border-radius: 10px; -fx-cursor: hand;");
        exitButton.setStyle("-fx-background-color: red; -fx-text-fill: white; -fx-font-size: 20px; -fx-padding: 10px 20px; -fx-border-color: black; -fx-border-width: 2px; -fx-border-radius: 10px; -fx-cursor: hand;");

        // Button hover effect
        replayButton.setOnMouseEntered(e -> replayButton.setScaleX(1.05));
        replayButton.setOnMouseExited(e -> replayButton.setScaleX(1.0));
        exitButton.setOnMouseEntered(e -> exitButton.setScaleX(1.05));
        exitButton.setOnMouseExited(e -> exitButton.setScaleX(1.0));


        homeLayout.getChildren().addAll(logoImageView, replayButton, exitButton);
